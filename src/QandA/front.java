...
public class front extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonStart.setBounds(140, 140, 130, 50);
        ...
        jButtonExit.setBounds(140, 200, 130, 50);

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Front backgrounds/another background.jpg"))); // NOI18N
        ...
        getContentPane().add(jPanel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 410, 300));
    ...
    private void jButtonStartMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonStartMouseEntered
        jButtonStart.setBackground(new Color(102,102,102));
    ...
    private void jButtonStartMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonStartMouseExited
        jButtonStart.setBackground(new Color(102, 255, 102));
    ...
    private void jButtonExitMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonExitMouseEntered
          jButtonExit.setBackground(new Color(102,102,102)); 
